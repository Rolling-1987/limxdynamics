...
class DampingHumanoidController : public ControllerBase {
...
public:
  // DampingHumanoidController(); // Default constructor
  DampingHumanoidController() {
    // Constructor implementation
    ROS_INFO("DampingHumanoidController constructor");
  }

  ~DampingHumanoidController() {
    ROS_INFO("DampingHumanoidController destructor");
  }
...
private:
  std::vector<scalar_t> damping_kd_;
};
